      ...
      <main className="pt-28 px-6 max-w-3xl mx-auto">
        ...
        {step === 1 && (
          <div className="bg-slate-900/60 p-6 rounded-xl border border-indigo-700/20">
            ...
            <input className="w-full mb-4 p-2 bg-slate-800 rounded"
            ...
            <input type="date" className="w-full mb-4 p-2 bg-slate-800 rounded"
