    ...
    <div className="backdrop-blur-md bg-black/30 border-b border-indigo-700/20">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#" className="text-slate-200 hover:text-white">Track</a>
          <a href="#" className="text-slate-200 hover:text-white">Wallet</a>
          <a href="#" className="text-slate-200 hover:text-white">Pricing</a>
          <a href="#" className="text-slate-200 hover:text-white">Contact</a>
        </nav>
          ...
          <div className="mt-6 text-center rounded-lg mb-10 bg-slate-100 p-3">
            <button
              className={`px-4 py-2 rounded-lg font-medium ${
                !showCustom ? "bg-white" : "text-slate-600"
              }`}
